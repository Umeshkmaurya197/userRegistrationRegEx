...
public class UserRegistrationProblem {
	...
	private static String firstNamePattern = "[A-Z][a-z]{3,}"; // First name starts with Cap and has minimum 3
																// characters
	...
	private static String passowrdPattern4 = "^(?=.*[A-Z])(?=.*[0-9])(?=.*[!#@%^&*(){}]).*$";// Should have at exactly 1
																								// special Character
	...
	public static void main(String[] args) {
		try {
			...
			System.out.println("Password Match rule3 : " + passwordMatch3("Billgateorg3"));// true
			System.out.println("Password Match rule4 : " + passwordMatch4("Billgateorg3@"));// true

			if (firstNameMatch("Umesh") == false || lastNameMatch("Maurya") == false ||
			    emailMatch("abc.xyz@bl.co.in") == false || mobileMatch("+91 9919819801")==false|| 
			    passwordMatch1("billgateorg") == false || passwordMatch2("BillgateOrg")==false || 
			    passwordMatch3("Billgateorg3") == false || passwordMatch4("Billgateorg3@") == false)
			{
